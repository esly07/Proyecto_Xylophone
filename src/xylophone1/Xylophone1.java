...
public class Xylophone1 extends Application {
    ...
    @Override public void start(final Stage stage) {
        ...
        final AudioClip bar1Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note1.wav").toString());
        final AudioClip bar2Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note2.wav").toString());
        final AudioClip bar3Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note3.wav").toString());
        final AudioClip bar4Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note4.wav").toString());
        final AudioClip bar5Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note5.wav").toString());
        final AudioClip bar6Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note6.wav").toString());
        final AudioClip bar7Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note7.wav").toString());
        final AudioClip bar8Note =
            new AudioClip(Xylophone1.class.getResource("audio/Note8.wav").toString());
